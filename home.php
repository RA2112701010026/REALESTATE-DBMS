...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>buy house</h3>
         <p>"Your Dream Home Awaits: Discover Comfort and Luxury in Every Corner!".</p>
      </div>

      <div class="box">
         <img src="images/icon-2.png" alt="">
         <h3>rent house</h3>
         <p>"Your Dream Home Awaits: Rent with Us Today!"</p>
      </div>

      <div class="box">
         <img src="images/icon-3.png" alt="">
         <h3>sell house</h3>
         <p>"Where Memories Are Made, Your New Beginning.</p>
      </div>

      <div class="box">
         <img src="images/icon-4.png" alt="">
         <h3>flats and buildings</h3>
         <p>"Elevate your living experience in these modern flats and chic buildings.".</p>
      </div>

      <div class="box">
         <img src="images/icon-5.png" alt="">
         <h3>shops and malls</h3>
         <p>"Discover endless treasures in every aisle."</p>
      </div>

      <div class="box">
         <img src="images/icon-6.png" alt="">
         <h3>24/7 service</h3>
         <p>"Uninterrupted Excellence: Our 24/7 Service Ensures Your Needs Are Met Around the Clock!".</p>
      </div>
