         ...
         <div class="box">
            ...
            <div class="box">
               ...
               <select name="status" class="input" required>
                  ...
                  <option value="under construction">SOLD OUT</option>
               </select>
            </div>
            <div class="box">
               <p>furnished</p>
...
if(isset($_POST['h_search'])){
   ...
   // Default query when no search or filter is applied
...
<section class="listings">
   <?php 
      // Conditionally display the heading based on whether it's a search or default view
   ...
   <div class="box-container">
      <?php
         ...
         while($fetch_property = $select_properties->fetch(PDO::FETCH_ASSOC)){
            ...
            // Form for each property with save button
            echo '<form action="" method="POST">';
            echo '<div class="box">';
            echo '<input type="hidden" name="property_id" value="' . $fetch_property['id'] . '">';
            ...
            echo '<p class="total-images"><i class="far fa-image"></i><span>' . $total_images . '</span></p>';
            echo '<img src="uploaded_files/' . $fetch_property['image_01'] . '" alt="">';
            echo '</div>';
            
            echo '<div class="admin">';
            echo '<h3>' . substr($fetch_user['name'], 0, 1) . '</h3>';
            echo '<div>';
            echo '<p>' . $fetch_user['name'] . '</p>';
            echo '<span>' . $fetch_property['date'] . '</span>';
            echo '</div>';
            echo '</div>';
            echo '</div>';
            
            echo '<div class="box">';
            echo '<div class="price"><i class="fas fa-indian-rupee-sign"></i><span>' . $fetch_property['price'] . '</span></div>';
            echo '<h3 class="name">' . $fetch_property['property_name'] . '</h3>';
            echo '<p class="location"><i class="fas fa-map-marker-alt"></i><span>' . $fetch_property['address'] . '</span></p>';
            
            echo '<div class="flex">';
            echo '<p><i class="fas fa-house"></i><span>' . $fetch_property['type'] . '</span></p>';
            echo '<p><i class="fas fa-tag"></i><span>' . $fetch_property['offer'] . '</span></p>';
            echo '<p><i class="fas fa-bed"></i><span>' . $fetch_property['bhk'] . ' BHK</span></p>';
            echo '<p><i class="fas fa-trowel"></i><span>' . $fetch_property['status'] . '</span></p>';
            echo '<p><i class="fas fa-couch"></i><span>' . $fetch_property['furnished'] . '</span></p>';
            echo '<p><i class="fas fa-maximize"></i><span>' . $fetch_property['carpet'] . 'sqft</span></p>';
            echo '</div>';
            
            echo '<div class="flex-btn">';
            echo '<a href="view_property.php?get_id=' . $fetch_property['id'] . '" class="btn">view property</a>';
...
<!-- Include necessary scripts and components -->
